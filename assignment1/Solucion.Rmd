...
# Regresion para los puntos del final y test. MA-3
trend.estimated.train[1] <- trend.estimated.train[2]

last_n_lm <- lm(
    serie.ts.train[(length(serie.ts.train) - 2):length(serie.ts.train)] ~ serie.ts.train.time[(length(serie.ts.train) - 2):length(serie.ts.train)]
)
trend.estimated.train[length(serie.ts.train)] <- last_n_lm$fitted.values[3]
trend.estimated.test <- last_n_lm$coefficients[1] + serie.ts.test.time*last_n_lm$coefficients[2]
